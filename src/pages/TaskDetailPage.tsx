                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <button 
                        ...
                        className="w-24 h-24 border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center hover:border-blue-400 transition-colors bg-white"
                      >
